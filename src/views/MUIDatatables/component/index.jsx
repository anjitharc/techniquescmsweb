...
const Example = () => {
      ...
      options: {
        ...
        customBodyRender: (value, tableMeta, updateValue) => (
          <FormControlLabel
            aria-label="name"
            value={value}
            control={<TextField variant="standard" value={value} />}
    ...
    },
    {
      ...
      options: {
        ...
        customBodyRender: (value, tableMeta, updateValue) => (
          <FormControlLabel
            aria-label="age"
            control={<TextField variant="standard" InputProps={{ inputProps: { min: 0 } }} value={value || ''} type="number" />}
            onChange={(event) => updateValue(event.target.value)}
          />
        )
      }
  ...
  return (
    <>
      <Breadcrumb title="Editable Table">
