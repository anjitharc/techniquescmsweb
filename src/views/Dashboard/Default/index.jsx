...
const Default = () => {
  ...
  const [totalcust , totalcustchange] = useState();
   ...
   useEffect(() => {
      fetch(Url + companyid + "/dashboard_datas")
        .then((res) => {
          return res.json();
        })
        .then((resp) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <Grid container spacing={gridSpacing}>
          ...
          <Grid item lg={3} sm={6} xs={12}>
            <ReportCard
              primary={complaintdata}
              secondary="Complaints"
              color={theme.palette.error.main}
              footerData="Pending Complaints"
          ...
          <Grid item lg={3} sm={6} xs={12}>
            <ReportCard
              ...
              footerData="Connections Pending"
